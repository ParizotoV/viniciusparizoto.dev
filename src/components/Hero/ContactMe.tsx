  ...
  return (
    <div className='mx-8 px-8 relative border-orange border rounded md:mx-0 md:px-16 pb-4 pt-10 mt-6'>
      ...
      <p className='text-center md:text-left'>
        <a href='https://linkedin.com/in/viniciusvparizoto' title='LinkedIn Profile'>
          <FaLinkedin className='text-5xl md:text-6xl inline-block md:mr-6' />
        </a>
        <a href='https://github.com/ParizotoV' title='GitHub Profile'>
        ...
        <br />
        <span className='inline-block mt-4'>or drop a line: parizotov@gmail.com</span>
      </p>
    </div>
  )
}
